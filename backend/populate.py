...
spike_chunsoft = Game(Name = "Spike Chunsoft", Location = "Japan")
...
naughty_dog = GameStudio(Name = "Naught Dog", Location = "USA")

studio_list = [santa_monica, nintendo_epd, bandai, toby_fox, ninja_kiwi,
